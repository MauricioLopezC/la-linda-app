...
class UpdateCustomerRequest extends FormRequest
{
    ...
    {
        /** @var Customer|int|string|null $customerRoute */
        $customerRoute = $this->route('customer');
        $customerId = $customerRoute instanceof Customer ? $customerRoute->id : $customerRoute;
        ...
        $uniqueRule = Rule::unique('customers', 'id_number')->ignore($customerId);
