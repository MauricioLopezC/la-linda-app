...
class UpdateArticleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $articleId = $article instanceof Article ? $article->id : (int) $article;

        return [
            'description' => ['required', 'string', 'min:2', 'max:150'],
            'internal_code' => ['required', 'string', 'max:50', new UniqueNormalizedValue(Article::class, 'internal_code_normalized', $articleId)],
            'barcode' => ['nullable', 'string', 'max:50', new UniqueNormalizedValue(Article::class, 'barcode_normalized', $articleId)],
