...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $currentParentId = $category instanceof Category ? $category->parent_id : null;
        $parentId = $this->has('parent_id') ? ($this->integer('parent_id') ?: null) : $currentParentId;
        ...
        return [
            'name' => [
                ...
                'min:2',
                'max:100',
                new UniqueNormalizedValue(Category::class, 'name_normalized', $categoryId, [
